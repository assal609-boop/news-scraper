...
**مهم:** هذا الكود لا يحصر Facebook في نوع رابط واحد. يعني `/posts/...` و`/reel/...` وغيرها من الروابط التي تدعمها خدمة الاستخراج تمرّ من نفس النظام.

بعد ما تستبدلي `app.py`، **لا تنشري التعديل الآن** إذا بدك نمشي معي خطوة خطوة. أرسلي لي فقط صورة أو محتوى `requirements.txt` الموجود عندك، وبعدها أعطيك ملف `index.html` النهائي المتوافق معه.
